...
pub const INTEGER32_MASK: u64 = 0b001 << TYPE_MASK_OFFSET;
pub const SYMBOL_MASK: u64 = 0b011 << TYPE_MASK_OFFSET;
pub const CLOSURE_MASK: u64 = 0b010 << TYPE_MASK_OFFSET;
pub const ARRAY_MASK: u64 = 0b100 << TYPE_MASK_OFFSET;
